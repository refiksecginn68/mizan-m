...
import { blokToUdf } from "@/lib/services/belge-uret";

// eslint-disable-next-line @typescript-eslint/no-explicit-any
type Any = any;

// UDF üretimi src/lib/services/belge-uret.ts'te (tek kaynak — Dönüştürücü ile ortak).
export async function POST(request: Request) {
  try {
    ...
    const udf = await blokToUdf(bloklar);
